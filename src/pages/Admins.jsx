...
import { ShieldCheck, ShieldAlert, Key, Trash2, Loader2 } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {admins.map((admin) => (
          ...
          >
            ...
            <p className="text-slate-400 text-sm mb-2">{admin.email}</p>
            ...
            <div className="flex gap-2 mt-auto">
              {/* Permissions page is temporarily disabled */}
              {/* {isSuperAdmin && admin.role_name === "admin" && (
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={() =>
                    navigate(`/admins/edit-rights/${admin.user_id}`)
                  }
